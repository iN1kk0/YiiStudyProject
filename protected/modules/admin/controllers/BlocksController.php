...
class BlocksController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Blocks'])) {
            ...
            $model->buttonImage = CUploadedFile::getInstance($model, 'buttonImage');
            if (Blocks::model()->count() >= 3) {
                Yii::app()->user->setFlash('error', "Can't create more than 3 blocks");
            } else {
                if ($model->save()) {
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Blocks'])) {
            ...
            if (CUploadedFile::getInstance($model, 'buttonImage')) {
                $model->buttonImage = CUploadedFile::getInstance($model, 'buttonImage');
            }
